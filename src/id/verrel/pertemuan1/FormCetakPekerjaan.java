 ...
 * @author Verrel
 */
public class FormCetakPekerjaan extends javax.swing.JInternalFrame {

    /**
     * Creates new form FormCetak
     */
    public FormCetakPekerjaan() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cetak Laporan Pekerjaan?");
    ...
    private void cetakButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cetakButtonActionPerformed
        ...
        try {
            InputStream reportStream = getClass().getResourceAsStream("/ireportaplikasi/reportPekerjaan.jrxml");
            if (reportStream == null) {
                JOptionPane.showMessageDialog(this, "File reportPekerjaan.jrxml tidak ditemukan di classpath.");
                return;
            }
