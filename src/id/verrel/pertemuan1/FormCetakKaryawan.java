 ...
 * @author Verrel
 */
public class FormCetakKaryawan extends javax.swing.JInternalFrame {

    /**
     * Creates new form FormCetak
     */
    public FormCetakKaryawan() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cetak Laporan Data Karyawan?");
    ...
    private void cetakButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cetakButtonActionPerformed
        ...
        try {
            InputStream reportStream = getClass().getResourceAsStream("/ireportaplikasi/reportKaryawan.jrxml");
            if (reportStream == null) {
                JOptionPane.showMessageDialog(this, "File reportKaryawan.jrxml tidak ditemukan di classpath.");
                return;
            }
